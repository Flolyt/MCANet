...
ResultMapPath = 'D:/1/LPraNet-master/eval/result/';
Models = {'HardNet'}; %{'UNet','UNet++','PraNet','SFA'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = 'D:/1/LPraNet-master/data/TestDataset/';
...
%Datasets = {'CVC-300','CVC-ClinicDB','Kvasir'};
%Datasets = {'ETIS-LaribPolypDB','Kvasir'};
% ---- 3. Evaluation Results Save Path Setting ----
ResDir = 'D:/code/pranet/LPraNet-master/LPraNet-master/eval/Evaluate_HardNet_results/';
